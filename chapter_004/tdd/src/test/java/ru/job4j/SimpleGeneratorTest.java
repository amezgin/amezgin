...
public class SimpleGeneratorTest {
     ...
     */
    @Test
    public void whenGetTemplateThenReturnedReplacedString() throws KeyNotFoundException, MapContainsExtraKeyException {
     ...
     */
    @Test
    public void whenGetTemplateWithSomeKeysThenReturnedReplacedString() throws KeyNotFoundException, MapContainsExtraKeyException {
        SimpleGenerator simpleGenerator = new SimpleGenerator();
        Map<String, String> map = new HashMap<>();
    ...
    public void whenGetTemplateAndMapNotHasKeyThenReturnedException() throws KeyNotFoundException, MapContainsExtraKeyException {
        SimpleGenerator simpleGenerator = new SimpleGenerator();
        Map<String, String> map = new HashMap<>();
     ...
     * @throws MapContainsExtraKeyException exception when map contains extra keys.
     */
    @Test(expected = MapContainsExtraKeyException.class)
    public void whenGetTemplateAndMapHasExtraKeyThenReturnedException() throws KeyNotFoundException, MapContainsExtraKeyException {
        SimpleGenerator simpleGenerator = new SimpleGenerator();
        Map<String, String> map = new HashMap<>();
